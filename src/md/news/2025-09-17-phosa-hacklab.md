...
The Computational Life Science Lab at RWTH Aachen has been awarded funding in the first round of the **ENHANCE Alliance Testbed competition** for the project _PhoSA HackLab: Emulating Scientific Consultancy for Eco-Innovative Cities_.
...
It builds on the interdisciplinary course _Photosynthetic Systems in Architecture (PhoSA)_, funded through **Leitlinie 2024**, which connects biology and architecture students in developing sustainable urban solutions such as algae façades, vertical gardens, and green walls.
